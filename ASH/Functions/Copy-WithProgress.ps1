function Copy-WithProgress {
    ...
    $CommonRobocopyParams = '/MIR /NP /NDL /NC /BYTES /NJH /NJS /W:5 /R:5';
    ...
    $StagingArgumentList = '"{0}" "{1}" "{4}" /LOG:"{2}" /L {3}' -f $Source, $Destination, $StagingLogPath, $CommonRobocopyParams, $file;
    ...
    $ArgumentList = '"{0}" "{1}" "{5}" /LOG:"{2}" /ipg:{3} {4}' -f $Source, $Destination, $RobocopyLogPath, $Gap, $CommonRobocopyParams, $file;
    ...
    while (!$Robocopy.HasExited) {
        ...
        Write-Progress -Activity Robocopy -Status ("Copied {0} of {1} files; Copied {2} of {3} bytes" -f $CopiedFileCount, $TotalFileCount, $BytesCopied, $BytesTotal) -PercentComplete $Percentage -SourceId $ProgressSourceID
    }
