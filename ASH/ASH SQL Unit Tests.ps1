...
#$SQLServers += "tog-sql"
#$SQLServers += "SD-P-ProvSCHSQL"
#$SQLServers += "SD-P-ITSWEEP"
#$SQLServers += "SD-P-DWREPORTS"
...
$SQLServers +=  Get-DbaRegisteredServerName -SqlServer tog-sql | 
    Select -Expandproperty Name |
    where {$_ -ne "10.8.6.38"} |
    where {$_ -ne "sd-d-miccsql"}
